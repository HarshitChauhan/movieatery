...
function Actors() {
  ...
  const { data: actorMovies, isFetching: isActorsMovieFetching } = useGetMoviesByActorIdQuery({ id, pageNumber });
  ...
  return (
    <>
      ...
      <Box margin="2rem" width="100%">
        ...
        <Pagination currentPage={pageNumber} setPage={setPageNumber} totalPages={actorMovies?.total_pages} />
